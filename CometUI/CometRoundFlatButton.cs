...
namespace CometUI
{
	public class CometRoundFlatButton : Control
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			e.Graphics.DrawPath(new Pen(ForeColor, borderWidth), path);
			...
			else if (brightness <= 127)
			{
				...
				if (mouseDown)
					e.Graphics.DrawPath(new Pen(Color.FromArgb(60, Color.Black), borderWidth), path);
			}
